...
Instructions
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
One way is to run 'flask api.py' in this project directly. In this case, if you're using Windows system the homepage address is '127.0.0.1:5000', and if you're yusing ios system the address is '0.0.0.0:8000'. 
...
On the home page, enter text in the blank text box and select method(s) via check box, click 'submit' button then you'll see the result page. 
